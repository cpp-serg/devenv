        ...
        config = function()
            vim.api.nvim_create_autocmd('LspAttach', {
                ...
                callback = function(event)
                    ...
                    map('gt', ts_bi.lsp_type_definitions, 'Type [D]efinition')

                    -- Fuzzy find all the symbols in your current document.
                    --  Symbols are things like variables, functions, types, etc.
                    map('<leader>ds', ts_bi.lsp_document_symbols, '[D]ocument [S]ymbols')

                    -- Fuzzy find all the symbols in your current workspace
                    --  Similar to document symbols, except searches over your whole project.
                    map('<leader>ws', ts_bi.lsp_dynamic_workspace_symbols, '[W]orkspace [S]ymbols')
                    -- map('<leader>ws', ts_bi.lsp_workspace_symbols, '[W]orkspace [S]ymbols')

                    map('<leader>ic', ts_bi.lsp_incoming_calls, '[W]orkspace [S]ymbols')
                    map('<leader>oc', ts_bi.lsp_outgoing_calls, '[W]orkspace [S]ymbols')
